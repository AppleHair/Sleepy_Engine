...
extern "C" {
    ...
    // pub fn get_metadata_icon() -> Box<[u8]>;// table = 'blobs', rowid = 3
    #[wasm_bindgen(js_name=getMetadataScript)]
    pub fn get_metadata_script() -> String;// table = 'blobs', rowid = 2
    ...
    pub fn get_metadata_config() -> String;// table = 'blobs', rowid = 1
